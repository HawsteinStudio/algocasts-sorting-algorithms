...
class SortTest {
  private final int CNT = Helper.getRandomInt(50, 100);
  ...
  private final List<int[]> specialArrays = Arrays.asList(
    ...
    new int[]{-1},         // [负数] 一个元素
    new int[]{-2,-1},      // [负数] 两个元素，递增
    new int[]{-1,-2},      // [负数] 两个元素，递减
    new int[]{-1,-1},      // [负数] 两个元素，相同
    new int[]{-3,-2,-1},   // [负数] 三个元素，递增
    new int[]{-1,-2,-3},   // [负数] 三个元素，递减
    new int[]{-1,-1,-1},   // [负数] 三个元素，相同
